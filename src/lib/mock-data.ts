...
export const members: Member[] = [
  {
    ...
    family: [],
    familyName: 'Admin',
    avatarUrl: 'https://placehold.co/128x128/333333/FFFFFF.png',
    zone: '',
    ward: '',
    role: 'Admin',
  },
  {
    ...
    family: [
      { relation: 'Spouse', name: 'Jane Doe', birthday: '1988-04-12', phone: '555-0113', avatarUrl: 'https://placehold.co/128x128/FADADD/8B0000.png' },
      { relation: 'Child', name: 'Jimmy Doe', birthday: '2012-01-15', phone: 'N/A', avatarUrl: 'https://placehold.co/128x128/E0FFFF/008080.png' },
      { relation: 'Child', name: 'Jenny Doe', birthday: '2014-07-22', phone: 'N/A', avatarUrl: 'https://placehold.co/128x128/FFFACD/FFD700.png' },
    ],
  ...
  },
  {
    ...
    family: [
      { relation: 'Spouse', name: 'John Smith', birthday: '1989-11-30', phone: '555-0114', avatarUrl: 'https://placehold.co/128x128/C1E1C1/006400.png'},
      { relation: 'Child', name: 'Jake Smith', birthday: '2018-06-01', phone: 'N/A', avatarUrl: 'https://placehold.co/128x128/C1E1C1/006400.png' }
    ],
  ...
  },
  {
    ...
    family: [
      { relation: 'Spouse', name: 'Susan Williams', birthday: '1980-02-20', phone: '555-0115', avatarUrl: 'https://placehold.co/128x128/FFDAB9/A0522D.png' }
    ],
  ...
  },
  {
    ...
    family: [
      { relation: 'Spouse', name: 'Patricia Davis', birthday: '1982-08-20', phone: '555-0116', avatarUrl: 'https://placehold.co/128x128/B0E0E6/4682B4.png' },
      { relation: 'Child', name: 'Robert Davis', birthday: '2010-10-10', phone: 'N/A', avatarUrl: 'https://placehold.co/128x128/B0E0E6/4682B4.png' },
      { relation: 'Child', name: 'Jennifer Davis', birthday: '2012-12-12', phone: 'N/A', avatarUrl: 'https://placehold.co/128x128/B0E0E6/4682B4.png' },
    ],
  ...
  },
  {
    ...
    family: [
      { relation: 'Spouse', name: 'Richard Miller', birthday: '1974-01-01', phone: '555-0117', avatarUrl: 'https://placehold.co/128x128/F08080/800000.png' }
    ],
  ...
  },
  {
    ...
    family: [
        { relation: 'Spouse', name: 'William Moore', birthday: '1987-11-11', phone: '555-0118', avatarUrl: 'https://placehold.co/128x128/D8BFD8/4B0082.png' },
        { relation: 'Child', name: 'Jessica Moore', birthday: '2014-02-02', phone: 'N/A', avatarUrl: 'https://placehold.co/128x128/D8BFD8/4B0082.png' },
        { relation: 'Child', name: 'Daniel Moore', birthday: '2016-03-03', phone: 'N/A', avatarUrl: 'https://placehold.co/128x128/D8BFD8/4B0082.png' }
    ],
  ...
  },
  {
    ...
    family: [
        { relation: 'Spouse', name: 'Thomas Anderson', birthday: '1990-01-01', phone: '555-0119', avatarUrl: 'https://placehold.co/128x128/FFC0CB/800000.png' },
        { relation: 'Child', name: 'Sarah Anderson', birthday: '2020-10-10', phone: 'N/A', avatarUrl: 'https://placehold.co/128x128/FFC0CB/800000.png' }
    ],
